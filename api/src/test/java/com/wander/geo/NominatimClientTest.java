...
class NominatimClientTest {
    ...
    private static WanderProperties properties() {
        return new WanderProperties("test", "", "", true, "EUR", new WanderProperties.Admin("", ""),
                ...
                new WanderProperties.Quota(120, 60, 60, 40, 40, 5, 10000),
                ...
                new WanderProperties.Routing(false, "http://localhost:1", 12, "test",
                        "http://localhost:1", 200, 4000),
                new WanderProperties.Fx(true, "http://localhost:1", 24, "test",
                        "http://localhost:1", 200, 4000),
